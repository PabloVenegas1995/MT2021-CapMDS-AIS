...
int population_Creation = 0; // 0 creates the population randomly, 1 creates the population with Prof. Pinacho's Heuristics, 2 creates population with both alternatives

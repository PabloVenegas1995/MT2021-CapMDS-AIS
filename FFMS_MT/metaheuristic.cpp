...
int main( int argc, char **argv ) {
    ...
    // vectors for storing the result and the computation time obtained by the applications of the metaheuristic
    ...
    for (int na = 0; na < n_files; ++na) {
        ...
        // For implementing the metaheuristic you probably want to take profit from the greedy heuristic and/or the local search method that you already developed.
        ...
        // Stop the execution of the metaheuristic once the time limit "time_limit" is reached.
